---
title: "Hello, svelte-lazy-loader"
date: 2022-02-27
---
...
I've written and published my first package on NPM. Meet `svelte-lazy-loader`. It's a component library for effortlessly loading media using a shared IntersectionObserver instance if native lazy-loading doesn't exist.

I'm still catching up to the world of semantic versioning and tracking changes, as well as how to not accidentally publish an unchanged version. But it's not as hard as I thought! Here are the docs for `svelte-lazy-loader`.
...
<Image src="/images/rickroll.gif" alt="A gif of the iconic Rick Astley dancing to his song 'Never Gonna Give You Up' in the titular music video" />
```
