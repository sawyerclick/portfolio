...
var svg = d3.select('#chart-01').append('svg').attr('height', height + margin.top + margin.bottom).attr('width', width + margin.left + margin.right).append('g').attr('transform', 'translate(' + margin.left + ',' + margin.top + ')');
...
},{"d3":"../node_modules/d3/index.js","../data/player_stats.csv":"data/player_stats.csv"}]},{},["scripts/chart-01.js"], null)
