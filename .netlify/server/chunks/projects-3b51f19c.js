...
var data = [
  {
    ...
    description: "Led development of a multi-page site featuring several prominent data visualizations on police violence in America",
    date: "2022-02",
    tags: "SvelteKit,D3",
...
data.forEach((d) => {
  d.slug = (0, import_slugify.default)(d.title, { lowercase: true });
});
const pinned = data.filter(({ pinned: pinned2 }) => pinned2 === "TRUE");
const recent = data.filter(({ lead, img, type, pinned: pinned2 }) => pinned2 === "FALSE" && type === "graphics" && lead === "TRUE" && img);
var projects = { pinned, recent };
